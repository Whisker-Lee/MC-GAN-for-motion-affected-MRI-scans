...
python3.6 main_abide3.py  --mode test_only --pre_trained_model ./model/DeblurrGAN-89 --num_of_down_scale 4 --gen_resblocks 16 --discrim_blocks 5 --decay_step 500 --channel 3
...
python3.6 main_abide3_100.py  --mode test_only --pre_trained_model ./model/DeblurrGAN-89 --num_of_down_scale 4 --gen_resblocks 16 --discrim_blocks 5 --decay_step 500 --channel 3
