...
def test_only(args, model, sess, saver):
    ...
    if args.in_memory :
        ...
        os.mkdir('./low/')
        path = '/home/shared/shangjin_oasis_new/low_qual_model_test_adhd200_20200311/'
        cla = os.listdir(path)
                    ...
                    if k<3:
                        for kk in range(3):
                            ...
                            for ikk in range(3):
                                ...
                                plt.savefig('./low/'+ i + '/' + j +'/x'+str(k*3+kk)+'_'+str(ikk)+'.png')
                    ...
                    if k<3:
                        for kk in range(3):
                            ...
                            for ikk in range(3):
                                ...
                                image3[ikk] = image3[ikk].reshape(image3[ikk].shape[0],image3[ikk].shape[1],3)
                                skimage.io.imshow(image3[ikk])
                                plt.savefig('./low/'+ i + '/' + j +'/y'+str(k*3+kk)+'_'+str(ikk)+'.png')
                    ...
                    if k<3:
                        for kk in range(3):
                            ...
                            for ikk in range(3):
                                ...
                                image3[ikk] = image3[ikk].reshape(image3[ikk].shape[0],image3[ikk].shape[1],3)
                                skimage.io.imshow(image3[ikk])
                                plt.savefig('./low/'+ i + '/' + j +'/z'+str(k*3+kk)+'_'+str(ikk)+'.png')
