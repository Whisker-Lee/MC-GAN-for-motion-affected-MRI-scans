                    ...
                    if k<3:
                        for kk in range(3):
                            ...
                            for ikk in range(3):
                                ...
                                plt.savefig('./abide/'+ i + '/' + j +'/x'+str(k*3+kk)+'_'+str(ikk)+'.png')
                    ...
                    if k<3:
                        for kk in range(3):
                            ...
                            for ikk in range(3):
                                ...
                                image3[ikk] = image3[ikk].reshape(image3[ikk].shape[0],image3[ikk].shape[1],3)
                                skimage.io.imshow(image3[ikk])
                                plt.savefig('./abide/'+ i + '/' + j +'/y'+str(k*3+kk)+'_'+str(ikk)+'.png')
                    ...
                    if k<3:
                        for kk in range(3):
                            ...
                            for ikk in range(3):
                                ...
                                image3[ikk] = image3[ikk].reshape(image3[ikk].shape[0],image3[ikk].shape[1],3)
                                skimage.io.imshow(image3[ikk])
                                plt.savefig('./abide/'+ i + '/' + j +'/z'+str(k*3+kk)+'_'+str(ikk)+'.png')
