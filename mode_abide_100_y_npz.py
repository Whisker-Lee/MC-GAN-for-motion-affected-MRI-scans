    ...
    if args.in_memory :
        ...
        for i in cla:
            ...
            for j in cla_1:
                ...
                np.savez_compressed('/home/shared/shangjin_oasis_new/abide_result/'+ i + '/y_'  + i + '_' + j +  '_original.npz', payload = npz1)
                #batch = batch.reshape((batch.shape[0],batch.shape[1],batch.shape[2],1))
                ...
                np.savez_compressed('/home/shared/shangjin_oasis_new/abide_result/'+ i + '/y_'  + i + '_' + j +  '_input.npz', payload = npz2)
                np.savez_compressed('/home/shared/shangjin_oasis_new/abide_result/'+ i + '/y_'  + i + '_' + j +  '_output_model_xyz.npz', payload = npz3)
