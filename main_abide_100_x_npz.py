...
from mode_abide_100_x_npz import *
import argparse
...
parser.add_argument("--vgg_path", type = str, default = "../../vgg_lsj_4/VGG19_oasis.npy") #
...
parser.add_argument("--test_with_train", type = str2bool, default = False) #False
