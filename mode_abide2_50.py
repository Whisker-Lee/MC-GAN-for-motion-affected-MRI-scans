...
def test_only(args, model, sess, saver):
    ...
    if args.in_memory :
        ...
        os.mkdir('./med/')
        path = '/home/shared/shangjin_oasis_new/medium_quality_scans_03_24_2020/'
        cla = os.listdir(path)
                    ...
                    if k<3:
                        for kk in range(3):
                            ...
                            for ikk in range(2):
                                ...
                                plt.savefig('./med/'+ i + '/' + j +'/x'+str(k*3+kk)+'_'+str(ikk)+'.png')
                    ...
                    if k<3:
                        for kk in range(3):
                            ...
                            for ikk in range(2):
                                ...
                                image3[ikk] = image3[ikk].reshape(image3[ikk].shape[0],image3[ikk].shape[1],3)
                                skimage.io.imshow(image3[ikk])
                                plt.savefig('./med/'+ i + '/' + j +'/y'+str(k*3+kk)+'_'+str(ikk)+'.png')
                    ...
                    if k<3:
                        for kk in range(3):
                            ...
                            for ikk in range(2):
                                ...
                                image3[ikk] = image3[ikk].reshape(image3[ikk].shape[0],image3[ikk].shape[1],3)
                                skimage.io.imshow(image3[ikk])
                                plt.savefig('./med/'+ i + '/' + j +'/z'+str(k*3+kk)+'_'+str(ikk)+'.png')
